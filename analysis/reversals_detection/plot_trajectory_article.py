...
def plot_trajectory(x_column,
        ...
        if plot_traj:
            ...
            ax.scatter(x.to_numpy()[0], y.to_numpy()[0], s=s_rev, c='k', linewidths=3, marker="+", alpha=0.5, label="Start")
        ...
        if plot_traj_s:
            ...
            # ax.scatter(x_s.to_numpy()[0], y_s.to_numpy()[0], s=s_rev, c='k', linewidths=3, marker="+", alpha=0.5)
