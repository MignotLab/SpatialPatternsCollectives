...
print("\nTest image plot...")
plt_fluo_analysis.plt_fluo_analysis_fct(settings_dict_param_estim, iteration = iteration)
print("Please check if the detection of the leading poles worked rougly, in order to be sure about the distribution in the next step.")
...
# %% 
# 3 ----------LEADING POLE DETECTION---------

# this is the very first senseful leading pole detection with pole_on_thresh != 0
iteration = 0
...
plt_fluo_analysis.plt_fluo_analysis_fct(settings_dict_fluo_plot, iteration = iteration)
...
print("\n---REMOVING POLLUTION---\n")
df_fluo_updated = remove_pollution.remove_pollution_fct(regression_constant, regression_coefficient)
# --> saves analysis in analysis_corrected in default folder 


# %% 
# 6 ----------NEW LEADING POLE DETECTION------------
...
# %% 
# 8 ----------PLOT FINAL FLUORESCENCE ANALYSIS---------

# give an iteration here that is != 0
iteration = 1
...
import reversal_analysis
print("---REVERSAL DETECTION STARTED---\n")
merged_df = reversal_analysis.reversal_analysis_fct()


# %% 
# 10 ---------PLOT REVERSAL ANALYSIS-------------
...
# run plot reversal analysis
import plt_reversal_analysis
print("---REVERSAL PLOT STARTED---\n")
plt_reversal_analysis.plt_reversal_analysis_fct()
