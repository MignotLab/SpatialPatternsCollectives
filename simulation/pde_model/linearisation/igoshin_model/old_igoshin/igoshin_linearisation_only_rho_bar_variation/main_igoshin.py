...
path_save = "results/"
filename ="data_eigenvalues_igoshin_1d.csv"
...
# Save
filename ="rho_bar_values_1d.csv"
column_name = "rho_bar"
lin.initialize_directory_or_file(path=path_save+filename)
...
# Read_csv
path = "W:/jb/python/myxococcus_xanthus_simu1d/linearisation/igoshin_linearisation_only_rho_bar_variation/results/"
filename_data_igoshin = "data_eigenvalues_igoshin_1d.csv"
